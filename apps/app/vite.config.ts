...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      {
        find: '@redactly/core/coreference',
        replacement: path.join(coreRoot, 'coreference.ts'),
      },
      {
        find: '@redactly/core/customTypes',
        replacement: path.join(coreRoot, 'customTypes.ts'),
      },
